...
srun --ntasks=1 python3 test_run_v6_hpc.py --window 100 --torchdata 1 --use_f0 0 --do_normalization 1 --batch_size 100 --hpc 1 --known_inits 1 --dim_hidden 50 --n_layers 2 --activation gelu --output_dir "$round_dir/small_gelu_bs100_torchdata" &
